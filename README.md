...
This branch builds Astral Repository **1.11.11** for **Minecraft 26.3**, **NeoForge 26.3.0.7-beta or newer within Minecraft 26.3**, and **Java 25**. Install the matching JAR on both the client and server. No additional mod is required.
...
The installable JAR is `build/libs/astral_repository-26.3-neoforge-1.11.11.jar`.
