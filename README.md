...
This branch builds Astral Repository **1.11.8** for **Minecraft 26.3**, **NeoForge 26.3.0.6-beta or newer within Minecraft 26.3**, and **Java 25**. Install the matching JAR on both the client and server. No additional mod is required.

The selected NeoForge release is a beta.
...
The installable JAR is `build/libs/astral_repository-26.3-neoforge-1.11.8.jar`.
