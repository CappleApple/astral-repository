...
public final class AstralNetwork implements NetworkAccess {
    ...
    public String status(){return nodes.size()+" crystals Â· "+storages.size()+" stores Â· "+activeJobs()+" jobs\n"+(powered?throughput+" moved": "Needs power")+(!scans.isEmpty()||!dirty.isEmpty()?" Â· discovering":"")+(failed.isEmpty()?"":" Â· "+failed.size()+" unavailable");}
