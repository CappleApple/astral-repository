...
public final class DimensionalAttunementItem extends AstralToolItem {
    ...
    @Override public InteractionResult use(Level level,Player player,InteractionHand hand){
        ...
        if(!other.is(AstralContent.ASTRAL_NEXUS.get()))return com.cappleapple.astralrepository.port.Interactions.pass(upgrade);
        attuneNexus(level,player,other,upgrade);
        return com.cappleapple.astralrepository.port.Interactions.sidedSuccess(upgrade,level.isClientSide());
    }
