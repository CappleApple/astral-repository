...
public final class RuneGlyph {
    ...
    public static net.minecraft.resources.ResourceLocation id(RuneLayer.Mode mode){return new net.minecraft.resources.ResourceLocation("astral_repository",switch(mode){case PUSH->"push_rune";case PULL->"pull_rune";case FILTER->"filter_sigil";});}
