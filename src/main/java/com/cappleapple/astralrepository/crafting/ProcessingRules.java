...
public final class ProcessingRules extends SimpleJsonResourceReloadListener<JsonElement> {
    ...
    public static void registerReload(AddReloadListenerEvent event) { event.addListener(Identifier.fromNamespaceAndPath("astral_repository","processors"),new ProcessingRules()); }
