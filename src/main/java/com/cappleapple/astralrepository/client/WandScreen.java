...
public final class WandScreen extends Screen implements GhostIngredientScreen {
    ...
    private void send(WandPackets.Op op,UUID id,CompoundTag data){com.cappleapple.astralrepository.platform.network.PacketDistributor.sendToServer(new WandPackets.Action(session,op,id==null?new UUID(0,0):id,data));}
