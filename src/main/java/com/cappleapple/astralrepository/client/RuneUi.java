...
public final class RuneUi {
    ...
    public static void icon(GuiGraphicsExtractor g,RuneFilterSearch.Option option,int x,int y){
        ...
        if(rule.startsWith("fluid:")&&!rule.startsWith("fluid:#")){
            ...
            var sprite=model.stillMaterial().sprite(); int tint=net.fabricmc.fabric.api.transfer.v1.client.fluid.FluidVariantRendering.getColor(net.fabricmc.fabric.api.transfer.v1.fluid.FluidVariant.of(fluid));
