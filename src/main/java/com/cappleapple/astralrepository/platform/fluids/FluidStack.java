...
public final class FluidStack {
 ...
 public static FluidStack parseOptional(HolderLookup.Provider registries,CompoundTag tag){if(!tag.contains("Variant"))return EMPTY;return new FluidStack(FluidVariant.CODEC.parse(registries.createSerializationContext(NbtOps.INSTANCE),tag.get("Variant")).getOrThrow(),tag.getIntOr("Amount",0));}
}
