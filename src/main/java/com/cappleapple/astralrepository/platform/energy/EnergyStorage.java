...
public class EnergyStorage implements IEnergyStorage {
 ...
 public Tag serializeNBT(HolderLookup.Provider registries){return IntTag.valueOf(energy);}public void deserializeNBT(HolderLookup.Provider registries,Tag tag){energy=Math.clamp(tag instanceof NumericTag n?n.getAsInt():0,0,capacity);}
}
