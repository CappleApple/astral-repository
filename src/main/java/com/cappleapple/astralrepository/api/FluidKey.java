...
public final class FluidKey implements ResourceKey {
    ...
    public FluidKey(FluidStack stack) {
        ...
        sample = new FluidStack(stack,1);
        hash = java.util.Objects.hash(sample.getFluid(),sample.getTag());
    }
    ...
    @Override public boolean equals(Object other) {
        return other instanceof FluidKey key && sample.isFluidEqual(key.sample);
    }
