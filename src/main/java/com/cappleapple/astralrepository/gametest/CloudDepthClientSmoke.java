...
public final class CloudDepthClientSmoke {
    private static final Path OUT=Path.of("../build/client-smoke/cloud-depth");
    ...
    public static void verify() throws Exception {
        ...
        try {
            ...
            Files.writeString(OUT.getParent().resolve("result.txt"),"PASS: cloud-depth GPU regression; see cloud-depth/result.txt.\n");
    ...
    private static void render(int effect,boolean fabulous)throws Exception {
        ...
        if(fabulous) {
            ...
            var field=LevelRenderer.class.getDeclaredField("transparencyChain");field.setAccessible(true);
            ((PostChain)field.get(level)).process(0);main.bindWrite(true);
        } else {
