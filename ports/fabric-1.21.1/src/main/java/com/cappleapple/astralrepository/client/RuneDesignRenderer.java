...
public final class RuneDesignRenderer {
    ...
    public static ResourceLocation texture(RuneDesign design,int resolution){
        ...
        try{
            ...
            RenderSystem.getModelViewStack().identity().translate(0,0,-11000);RenderSystem.applyModelViewMatrix();RenderSystem.enableBlend();RenderSystem.defaultBlendFunc();
            ...
            AstralPlaneRenderType.setWorldSpace(worldSpace);mc.getTextureManager().release(base);target.destroyBuffers();RenderSystem.getModelViewStack().popMatrix();RenderSystem.applyModelViewMatrix();RenderSystem.setProjectionMatrix(projection,sorting);
