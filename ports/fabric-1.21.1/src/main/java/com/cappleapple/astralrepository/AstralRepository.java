...
import io.github.fabricators_of_create.porting_lib.registry.*;
...
public final class AstralRepository implements net.fabricmc.api.ModInitializer {
    ...
    @Override public void onInitialize(){
        io.github.fabricators_of_create.porting_lib.config.ConfigRegistry.registerConfig(MOD_ID,io.github.fabricators_of_create.porting_lib.config.ModConfig.Type.COMMON,AstralConfig.SPEC);
        io.github.fabricators_of_create.porting_lib.config.ConfigRegistry.registerConfig(MOD_ID,io.github.fabricators_of_create.porting_lib.config.ModConfig.Type.SERVER,AstralServerConfig.SPEC,"astral_repository-server.toml");
        io.github.fabricators_of_create.porting_lib.config.ConfigRegistry.registerConfig(MOD_ID,io.github.fabricators_of_create.porting_lib.config.ModConfig.Type.COMMON,CompatConfig.SPEC,"astral_repository-compat.toml");
        ...
        net.fabricmc.fabric.api.event.lifecycle.v1.ServerChunkEvents.CHUNK_LOAD.register((level,chunk)->{var event=new com.cappleapple.astralrepository.platform.event.level.ChunkEvent.Load(level,chunk);NetworkManager.chunkLoad(event);AstralMineralMigration.loaded(event);});
