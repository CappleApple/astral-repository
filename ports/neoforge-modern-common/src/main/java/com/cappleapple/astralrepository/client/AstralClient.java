...
public final class AstralClient {
    ...
    @SubscribeEvent public static void reload(AddClientReloadListenersEvent event){event.addListener(net.minecraft.resources.Identifier.fromNamespaceAndPath("astral_repository","rune_textures"),(net.minecraft.server.packs.resources.ResourceManagerReloadListener) manager->RuneDesignRenderer.clearTextures());}
    @SubscribeEvent public static void blockColors(RegisterColorHandlersEvent.BlockTintSources event){
    ...
    @SubscribeEvent public static void itemColors(RegisterColorHandlersEvent.ItemTintSources event){
