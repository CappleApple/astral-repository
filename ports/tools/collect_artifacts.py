...
def main():
    ...
    instructions.write_text(
        ...
        'Fabric targets require Fabric API. Configuration and energy libraries, plus model libraries where needed, are bundled.\n'
        'Java runtime: 1.20.1 = Java 17; 1.21.1 = Java 21; 26.2 and 26.3 = Java 25.\n'
        'The original 1.21.1 NeoForge build is included.\n\n'
        'Validated loader and required API versions:\n'
        '  Minecraft 1.21.1 NeoForge: NeoForge 21.1.244.\n'
        '  Minecraft 1.20.1 Forge: Forge 47.4.10.\n'
        '  Minecraft 1.20.1 Fabric: Fabric Loader 0.19.5; Fabric API 0.92.12+1.20.1.\n'
        '  Minecraft 1.21.1 Fabric: Fabric Loader 0.19.5; Fabric API 0.116.17+1.21.1.\n'
        '  Minecraft 26.2 Fabric: Fabric Loader 0.19.5; Fabric API 0.161.0+26.2.\n'
        '  Minecraft 26.2 NeoForge: NeoForge 26.2.0.88.\n'
        '  Minecraft 26.3 Fabric: Fabric Loader 0.19.5; Fabric API 0.161.0+26.3.\n'
        '  Minecraft 26.3 NeoForge: NeoForge 26.3.0.7-beta; no stable 26.3 release was available.\n\n'
        'Optional integrations are not required or bundled; see the matching branch README for tested versions and limits.\n'
