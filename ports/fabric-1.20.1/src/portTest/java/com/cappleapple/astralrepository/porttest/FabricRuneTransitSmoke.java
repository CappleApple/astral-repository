...
public final class FabricRuneTransitSmoke implements net.fabricmc.api.ModInitializer {
    @Override public void onInitialize(){
        ...
        ServerLifecycleEvents.SERVER_STARTED.register(server->{
            // Prevent the legacy asynchronous file watcher from racing deliberate config toggles inside one tick.
            com.cappleapple.astralrepository.AstralConfig.SPEC.setConfig(com.electronwill.nightconfig.core.CommentedConfig.inMemory());
            com.cappleapple.astralrepository.AstralServerConfig.SPEC.setConfig(com.electronwill.nightconfig.core.CommentedConfig.inMemory());
