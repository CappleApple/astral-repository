...
public final class AstralMineralClient {
    ...
    public static void shaders(net.fabricmc.fabric.api.client.rendering.v1.CoreShaderRegistrationCallback.RegistrationContext context) throws IOException {
        context.register(new ResourceLocation(AstralContent.MOD_ID,"astral_plane"),DefaultVertexFormat.NEW_ENTITY,AstralPlaneRenderType::loaded);
        context.register(new ResourceLocation(AstralContent.MOD_ID,"resource_transfer"),DefaultVertexFormat.NEW_ENTITY,ResourceTransferRenderer::loaded);
    }
