...
public final class TransferRenderPass extends RenderStateShard {
    ...
    static final WriteMaskStateShard SPRITE_WRITE=new WriteMaskStateShard(true,false) {
    ...
    private TransferRenderPass() {super("astral_transfer_pass",()->{},()->{});}
}
