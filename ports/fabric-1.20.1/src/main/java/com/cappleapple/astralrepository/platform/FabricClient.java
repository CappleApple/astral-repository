...
public final class FabricClient implements net.fabricmc.api.ClientModInitializer {
 @Override public void onInitializeClient(){
  io.github.fabricators_of_create.porting_lib.config.ConfigRegistry.registerConfig("astral_repository",io.github.fabricators_of_create.porting_lib.config.ConfigType.CLIENT,com.cappleapple.astralrepository.AstralClientConfig.SPEC,"astral_repository-client.toml");
