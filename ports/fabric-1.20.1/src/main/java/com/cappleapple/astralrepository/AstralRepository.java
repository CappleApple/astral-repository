...
public final class AstralRepository implements net.fabricmc.api.ModInitializer {
    ...
    @Override public void onInitialize(){
        io.github.fabricators_of_create.porting_lib.config.ConfigRegistry.registerConfig(MOD_ID,io.github.fabricators_of_create.porting_lib.config.ConfigType.COMMON,AstralConfig.SPEC);
        io.github.fabricators_of_create.porting_lib.config.ConfigRegistry.registerConfig(MOD_ID,io.github.fabricators_of_create.porting_lib.config.ConfigType.SERVER,AstralServerConfig.SPEC,"astral_repository-server.toml");
        io.github.fabricators_of_create.porting_lib.config.ConfigRegistry.registerConfig(MOD_ID,io.github.fabricators_of_create.porting_lib.config.ConfigType.COMMON,CompatConfig.SPEC,"astral_repository-compat.toml");
