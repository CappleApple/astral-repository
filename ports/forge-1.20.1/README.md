...
This directory builds the Forge edition, version 1.11.11. The original Minecraft 1.21.1 NeoForge edition remains at the repository root. See the [project README](../../README.md) for the full gameplay guide.
