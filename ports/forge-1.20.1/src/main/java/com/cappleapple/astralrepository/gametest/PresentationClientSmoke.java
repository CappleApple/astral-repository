...
public final class PresentationClientSmoke {
    ...
    public static boolean tick()throws Exception{
        ...
        else if(phase==3&&ticks>10){shot("held_gem_full_overlay.png");com.cappleapple.astralrepository.AstralClientConfig.astralOverlayOpacity.set(opacity);server(()->{var p=player();var face=RuneSurfaces.get(p.serverLevel(),HOST,Direction.SOUTH);RuneSettingsPackets.open(p,face,face.layers().get(0));});next(4);}
