...
public final class AstralClientConfig {
    ...
    public static final ForgeConfigSpec.DoubleValue astralOverlayOpacity = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue astralInterfaceOverlayOpacity = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue astralShootingStars = BUILDER
            .comment("Occasional pixelated shooting stars inside astral world, item, and interface fields.")
            .define("astralShootingStars", true);
    public static final ForgeConfigSpec.DoubleValue astralLayerDriftSpeed = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue astralLayerWobbleSpeed = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue astralParticleSpeed = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue astralTwinkleSpeed = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue astralShootingStarSpeed = BUILDER
    ...
    public static final ForgeConfigSpec.DoubleValue transferPathVariation = BUILDER.comment("Maximum cosmetic sideways deviation in blocks for each resource batch. Variation stays active through relay crossings and fades only at the source and destination. Zero keeps identical paths. Resource landing positions use resourceArrivalVariance.").defineInRange("transferPathVariation", 0.2, 0.0, 2.0);
    public static final ForgeConfigSpec.DoubleValue resourceArrivalVariance = BUILDER.comment("Maximum distance in blocks from the destination center for each fluid, energy, or Source batch landing point. Zero lands at the center; sampled once per new flight. These sprites fade only inside the destination block.").defineInRange("resourceArrivalVariance", 0.18, 0.0, 0.45);
    public static final ForgeConfigSpec.IntValue maxActiveTransfers = BUILDER.comment("Maximum live transfer animations. New cosmetic flights are sampled out at this limit; admitted flights finish normally. Does not limit actual transfers.").defineInRange("maxActiveTransfers",4096,64,65536);
    public static final ForgeConfigSpec.IntValue maxItemTransferModels = BUILDER.comment("Maximum simultaneous full 3D moving item models. Additional item flights use batched flat icons; all media share maxActiveTransfers.").defineInRange("maxItemTransferModels",128,0,4096);
    public static final ForgeConfigSpec.IntValue maxResourceTrails = BUILDER.comment("Maximum detached resource trail sprites. Existing trails finish before new ones are admitted.").defineInRange("maxResourceTrails",512,0,8192);
    public static final ForgeConfigSpec.IntValue maxTransferTrailEmissions = BUILDER.comment("Maximum trail emissions per client tick before particleDensity is applied. Shared fairly across active flights.").defineInRange("maxTransferTrailEmissions",32,0,512);
    public static final ForgeConfigSpec.IntValue transferRenderDistance = BUILDER.comment("Maximum distance in blocks for transfer models, resource sprites, and their trails.").defineInRange("transferRenderDistance",96,16,256);
