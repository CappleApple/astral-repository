...
public final class RuneTransitGameTests {
    ...
    public static void noninstantPushHoldsAllFourResourcesUntilTheirArrival(TransitTestWorld h) {
        delayed(h, RuneLayer.Mode.PUSH);
    }

    public static void noninstantPullHoldsAllFourResourcesUntilTheirArrival(TransitTestWorld h) {
        delayed(h, RuneLayer.Mode.PULL);
    }

    private static void delayed(TransitTestWorld h, RuneLayer.Mode mode) {
    ...
    public static void instantPushAndPullCommitAllFourResourcesOnDispatch(TransitTestWorld h) {
        boolean automatic = AstralConfig.instantAutomaticLogistics.get();
        boolean player = AstralConfig.instantPlayerInteractions.get();
        try {
    ...
    public static void oneTickCadencePipelinesThreeBatchesWithoutFinishingThemEarly(TransitTestWorld h) {
        boolean automatic = AstralConfig.instantAutomaticLogistics.get();
        Fixture fixture = null;
        try {
            AstralConfig.instantAutomaticLogistics.set(false);
    ...
    public static void stockTargetsCountAllInFlightReservationsBeforeSchedulingMore(TransitTestWorld h) {
        boolean automatic=AstralConfig.instantAutomaticLogistics.get();
        Fixture fixture=null;
        try {
            AstralConfig.instantAutomaticLogistics.set(false);
    ...
    public static void multipleRunesShareDestinationStockReservationsForEveryMedium(TransitTestWorld h) {
        boolean automatic=AstralConfig.instantAutomaticLogistics.get();
    ...
    public static void fullDestinationRefundsAllFourOwnedBatchesAtArrival(TransitTestWorld h) {
        boolean automatic=AstralConfig.instantAutomaticLogistics.get();
        Fixture fixture=null;
        try {
            AstralConfig.instantAutomaticLogistics.set(false);
    ...
    public static void removedDestinationRefundsOwnedBatchesWithoutUsingStaleCapabilities(TransitTestWorld h) {
        boolean automatic=AstralConfig.instantAutomaticLogistics.get();
        Fixture fixture=null;
        try {
            AstralConfig.instantAutomaticLogistics.set(false);
    ...
    public static void savedFlightsPreserveEveryMediumAndRemainingTimeAcrossClockReset(TransitTestWorld h) {
    ...
    public static void uncertainArrivalIsRecordedWithoutRefundOrReplay(TransitTestWorld h) {
        boolean automatic=AstralConfig.instantAutomaticLogistics.get();
        RuneLayer rune=null;
        try {
            AstralConfig.instantAutomaticLogistics.set(false);
    ...
    private static final class Fixture {
        ...
        Fixture(TransitTestWorld h, RuneLayer.Mode mode, int batches) {
            helper=h;
            ...
            CompatibilityRegistry.registerResources(id,(level,pos,side)->{
                ...
                var delegate=TransitTestWorld.scalar(id+index,arsSource,index);
