...
public final class AstralMineralClient {
    ...
    public static void models(ModelEvent.RegisterStandalone event){
    ...
    public static void items(RegisterSpecialModelRendererEvent event){event.register(Identifier.fromNamespaceAndPath(AstralContent.MOD_ID,"astral_mineral"),AstralMineralItemRenderer.Unbaked.CODEC);}
