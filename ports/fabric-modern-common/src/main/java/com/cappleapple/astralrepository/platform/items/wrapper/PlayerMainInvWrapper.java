...
public final class PlayerMainInvWrapper implements IItemHandler {
 ...
 public int getSlots(){return inventory.getNonEquipmentItems().size();} public ItemStack getStackInSlot(int slot){return inventory.getNonEquipmentItems().get(slot);}
