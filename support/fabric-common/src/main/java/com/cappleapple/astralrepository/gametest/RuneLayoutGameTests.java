...
public final class RuneLayoutGameTests {
    ...
    public static void hopperLayersSitOnRayReachableOutlineFaces(GameTestHelper h){
        ...
        var north=RuneLayout.cells(h.getLevel(),pos,Direction.NORTH,1).getFirst();
    ...
    public static void narrowContainersBoundTheirGlyphsAndChestBodyPlacementRemainsStable(GameTestHelper h){
        ...
        h.assertTrue(RuneLayout.cells(h.getLevel(),pos,Direction.UP,1).getFirst().size()<=0.125,"Brewing stand top glyph fits the narrow physical stem");
        ...
        double height=RuneLayout.cells(h.getLevel(),pos,Direction.NORTH,1).getFirst().center().y-pos.getY();
    ...
    public static void oneThroughFourUseFixedSizePatternsAndOnlyGlyphBoundsAreClickable(GameTestHelper h){
        ...
        for(Direction face:Direction.values()){
            var single=RuneLayout.cells(h.getLevel(),pos,face,1).getFirst();double size=single.size();
        ...
        var center=RuneLayout.cells(h.getLevel(),pos,Direction.NORTH,1).getFirst();
        for(int count=1;count<=4;count++){
